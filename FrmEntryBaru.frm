...
Begin VB.Form FrmEntryBaru 
   ...
   Begin VB.Label LblOK 
      ...
      Height          =   315
      Left            =   2160
      MouseIcon       =   "FrmEntryBaru.frx":0C2F
   ...
   Begin VB.Label LblBatal 
      ...
      Height          =   315
      Left            =   3360
      MouseIcon       =   "FrmEntryBaru.frx":0F39
      MousePointer    =   99  'Custom
      TabIndex        =   6
      Top             =   2720
      Width           =   1095
...
MsgBox "Nama kunci registry jangan dikosongkan !", vbCritical, "Error !!"
Exit Sub
End If
If TxtDiplayName.Text = "" Then
MsgBox "Nama program jangan dikosongkan !", vbCritical, "Error !!"
Exit Sub
End If
If TxtUninstallString.Text = "" Then
MsgBox "Perintah uninstall jangan dikosongkan !", vbCritical, "Error !!"
Exit Sub
End If
