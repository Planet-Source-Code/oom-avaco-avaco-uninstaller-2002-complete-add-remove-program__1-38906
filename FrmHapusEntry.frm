...
Begin VB.Form FrmHapusEntry 
   ...
   Begin VB.Label LblUninstall 
      ...
      Height          =   315
      Left            =   240
      MouseIcon       =   "FrmHapusEntry.frx":0CA4
   ...
   Begin VB.Label LblHapus 
      ...
      Height          =   315
      Left            =   2160
      MouseIcon       =   "FrmHapusEntry.frx":0FAE
      MousePointer    =   99  'Custom
      TabIndex        =   5
      Top             =   2720
      Width           =   1095
   ...
   Begin VB.Label LblBatal 
      ...
      Height          =   315
      Left            =   3360
      MouseIcon       =   "FrmHapusEntry.frx":12B8
      MousePointer    =   99  'Custom
      TabIndex        =   4
      Top             =   2720
      Width           =   1095
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   $"FrmHapusEntry.frx":15C2
      Height          =   975
      Left            =   240
      TabIndex        =   2
      Top             =   1560
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Yakin untuk menghapus List ini dari Registry :"
      Height          =   255
      Left            =   240
      TabIndex        =   1
      Top             =   600
