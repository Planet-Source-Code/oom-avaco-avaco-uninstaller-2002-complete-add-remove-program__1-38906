...
Begin VB.Form FrmMain 
   ...
   Begin MSComctlLib.ListView lstview 
      ...
      Left            =   120
      TabIndex        =   2
      ToolTipText     =   "Klik 2x program dalam list yang akan di uninstall"
      Top             =   1560
      Width           =   7140
      _ExtentX        =   12594
      _ExtentY        =   5265
...
For iKetetapan = 1 To sKeys.Count - 0
    ...
    If Len(Dname) > 0 Then
        ...
        End If
End If
    LblStatus.Caption = lstview.ListItems.Count & " Installasi Program"
Next iKetetapan
    Set sKeys = Nothing
...
Dname = GetString(HKEY_LOCAL_MACHINE, GetlocString & lstview.SelectedItem.Key, "DisplayName")
FrmBackupRegistry.LblInformasi = ">> Backup Untuk : " & Dname
End Sub
