...
Begin VB.Form FrmOption 
   ...
   Begin VB.PictureBox Picture4 
      ...
      Begin VB.CheckBox ChkUninstall 
         Appearance      =   0  'Flat
         BackColor       =   &H0038BCFF&
         Caption         =   "Tampilkan Dialog Uninstall !"
         ForeColor       =   &H80000008&
         Height          =   255
         Left            =   120
         TabIndex        =   11
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   240
      Picture         =   "FrmOptions.frx":11CC
      Top             =   3240
      Width           =   480
   End
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Urut List View Secara :"
      Height          =   255
      Left            =   240
      TabIndex        =   1
      Top             =   1080
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Tampilan List View berdasarkan :"
      Height          =   255
      Left            =   240
      TabIndex        =   0
      Top             =   480
...
End Select
If lReturn = 0 Then
  MsgBox "Pembuatan Shortcut Error !"
Else
  MsgBox "Pembuatan Shortcut Sukses !"
End If
End Sub
