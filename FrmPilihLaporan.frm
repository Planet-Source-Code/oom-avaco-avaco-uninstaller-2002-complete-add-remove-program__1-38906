...
Begin VB.Form FrmPilihLaporan 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.OptionButton OptDName 
         Appearance      =   0  'Flat
         BackColor       =   &H0038BCFF&
         Caption         =   "Hanya menampilkan "" Display Name """
         ForeColor       =   &H80000008&
         Height          =   210
         Left            =   80
         TabIndex        =   4
      ...
      Begin VB.OptionButton OptDnameUString 
         Appearance      =   0  'Flat
         BackColor       =   &H0038BCFF&
         Caption         =   "Display Name Dan Uninstall String "
         ForeColor       =   &H80000008&
         Height          =   255
         Left            =   80
         TabIndex        =   3
      ...
      Begin VB.OptionButton OptDetailInformasi 
         Appearance      =   0  'Flat
         BackColor       =   &H0038BCFF&
         Caption         =   "Detail Informasi Laporan"
         ForeColor       =   &H80000008&
         Height          =   255
         Left            =   80
         TabIndex        =   2
   ...
   Begin VB.Label LblBatal 
      ...
      Height          =   315
      Left            =   2760
      MouseIcon       =   "FrmPilihLaporan.frx":0B7A
   ...
   Begin VB.Label LblOK 
      ...
      Height          =   315
      Left            =   1560
      MouseIcon       =   "FrmPilihLaporan.frx":0E84
      MousePointer    =   99  'Custom
      TabIndex        =   0
      Top             =   1530
      Width           =   1095
