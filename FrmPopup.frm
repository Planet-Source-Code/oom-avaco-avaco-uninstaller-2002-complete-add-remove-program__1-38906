...
Begin VB.Form FrmPopup 
   ...
   Begin VB.Menu Menu7 
      ...
      Begin VB.Menu MnuMinimalWindow 
         Caption         =   "Window Minimal "
      End
      Begin VB.Menu MnuKWindow 
         Caption         =   "Kembalikan Window"
      End
      Begin VB.Menu MnuMaksWindow 
         Caption         =   "Window Maksimal "
      End
   End
   Begin VB.Menu Menu8 
      Caption         =   "Menu8"
      Begin VB.Menu MnuBantuan 
         Caption         =   "Topik Bantuan"
      End
      Begin VB.Menu spr11 
         Caption         =   "-"
         Index           =   0
...
Dim result
result = MsgBox("Anda ingin memodifikasi langsung melalui regedit ?" + vbCrLf & _
"Lokasi pengeditannya adalah sebagai berikut :" + vbCrLf & _
"[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{Nama Program}]", vbYesNo, "Pengeditan melalui Regedit.exe")
