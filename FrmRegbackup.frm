...
Begin VB.Form FrmBackupRegistry 
   ...
   Begin VB.TextBox TxtSimpan 
      ...
      Left            =   3360
      TabIndex        =   3
      ToolTipText     =   "Tulis nama yang akan disimpan disini"
      Top             =   4110
      Width           =   2745
   End
   ...
   Begin MSComctlLib.TreeView TreeViewBackup 
      ...
      Left            =   150
      TabIndex        =   5
      ToolTipText     =   "Silahkan klik 2x untuk meng-Export backup ke Registry"
      Top             =   720
      Width           =   2235
      _ExtentX        =   3942
      _ExtentY        =   5741
   ...
   Begin VB.Label LblBSUS 
      ...
      Caption         =   "Backup Semua Uninstall (Key)"
      Enabled         =   0   'False
      Height          =   255
      Left            =   620
      TabIndex        =   13
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Contoh  >>   ; Informasi untuk program AVACO"
      Height          =   255
      Left            =   360
      TabIndex        =   9
      Top             =   5220
...
result = MsgBox("Kamu yakin untuk menghapus Backup Registry : " & TreeViewBackup.SelectedItem.Text & "?", vbInformation + vbYesNo, "Hapus")
...
Exit Sub
agus:
MsgBox "File yang ingin dihapus tidak ada !!", vbOKOnly + vbCritical, "Error !!"
End Sub
...
LblInformasi.Caption = ">> Backup Untuk : Semua Uninstall (Key) yang ada dalam registry"
TreeViewBackup.Nodes.Clear
chkBakup.Caption = "<< Lihat list Backup"
...
Nodes
LblInformasi.Caption = ">> Silahkan klik 2x untuk meng-Export backup ke Registry"
TxtBackup.Text = ""
LblOK.Enabled = False
chkBakup.Caption = "Kembali >>"
TxtSimpan.Text = ""
...
MsgBox "Tulisan dalam Text tidak ditemukan !!", vbCritical, "error !!"
Exit Sub
End If
...
If retval = ad Then
result = MsgBox("File dengan nama [ " & retval & " ] telah ada." + vbCrLf & _
"Anda ingin menggantikannya ?", vbInformation + vbYesNo, "Informasi !!")
If result = vbYes Then
fName = App.Path & "\Backup Registry\" & num & ".reg"
Close #1
...
If Len(textload) >= 500000 Then
      MsgBox "File {" & App.Path & "\temp" & ".tmp" & "} Terlalu besar untuk dibuka", vbCritical, "Error !!"
      GoTo ld_end
    End If
  Loop
TxtBackup = textload
