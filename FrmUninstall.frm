...
Begin VB.Form frmUninstall 
   ...
   Begin VB.Label LblBatal 
      ...
      Height          =   315
      Left            =   2760
      MouseIcon       =   "FrmUninstall.frx":0E18
      MousePointer    =   99  'Custom
      TabIndex        =   2
      Top             =   1515
      Width           =   1095
   ...
   Begin VB.Label LblUninstall 
      ...
      Height          =   315
      Left            =   1560
      MouseIcon       =   "FrmUninstall.frx":1122
      MousePointer    =   99  'Custom
      TabIndex        =   1
      Top             =   1515
      Width           =   1095
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   240
      Picture         =   "FrmUninstall.frx":142C
      Top             =   520
      Width           =   480
   End
   Begin VB.Label LblInfomasi2 
      BackStyle       =   0  'Transparent
      Caption         =   "Apakah anda yakin untuk menjalankan Uninstall program ini ?"
      Height          =   495
      Left            =   880
      TabIndex        =   0
      Top             =   570
